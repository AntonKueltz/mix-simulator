...
class TestShift(TestCase):
    def test_execute_multiple(self) -> None:
        ...
        # SRAX 1
        instruction = Instruction(1, 0, 3, OpCode.SH)
        ...
        # SLA 2
        instruction = Instruction(2, 0, 0, OpCode.SH)
        ...
        # SRC 4
        instruction = Instruction(4, 0, 5, OpCode.SH)
        ...
        # SRA 2
        instruction = Instruction(2, 0, 1, OpCode.SH)
        ...
        # SLC 501
        instruction = Instruction(501, 0, 4, OpCode.SH)
