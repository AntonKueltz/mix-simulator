...
class TestJump(TestCase):
    ...
    def test_execute_jmp(self) -> None:
        instruction = Instruction(2000, 0, 0, OpCode.JMP)
        expected = 2000
    ...
    def test_execute_jsp(self) -> None:
        instruction = Instruction(2000, 0, 1, OpCode.JMP)
        expected = 2000
    ...
    def test_execute_jov(self) -> None:
        instruction = Instruction(2000, 0, 2, OpCode.JMP)
        expected = 2000
        j = JumpRegister(Byte(15), Byte(40))
    ...
    def test_execute_jnov_overflow_on(self) -> None:
        instruction = Instruction(2000, 0, 3, OpCode.JMP)
        expected = 1000
        j = JumpRegister(Byte(1), Byte(36))
    ...
    @parameterized.expand(
        [
            # JL 2000
            (
                Instruction(2000, 0, 4, OpCode.JMP),
            ...
            # JE 2000
            (
                Instruction(2000, 0, 5, OpCode.JMP),
                ComparisonIndicator.GREATER,
                1000,
                JumpRegister(Byte(1), Byte(36)),
            ),
            ...
            # JG 2000
            (
                Instruction(2000, 0, 6, OpCode.JMP),
                ComparisonIndicator.EQUAL,
                1000,
                JumpRegister(Byte(1), Byte(36)),
            ),
            ...
            # JGE 2000
            (
                Instruction(2000, 0, 7, OpCode.JMP),
                ComparisonIndicator.EQUAL,
                2000,
                JumpRegister(Byte(15), Byte(40)),
            ),
            ...
            # JNE 2000
            (
                Instruction(2000, 0, 8, OpCode.JMP),
                ComparisonIndicator.GREATER,
                2000,
                JumpRegister(Byte(15), Byte(40)),
            ),
            ...
            # JLE 2000
            (
                Instruction(2000, 0, 9, OpCode.JMP),
                ComparisonIndicator.EQUAL,
                2000,
                JumpRegister(Byte(15), Byte(40)),
            ),
    ...
    @parameterized.expand(
        [
            # JAN
            (
                Instruction(2000, 0, 0, OpCode.JA),
                True,
                (Byte(1), Byte(0), Byte(0), Byte(0), Byte(0)),
            ),
            # JAZ
            (
                Instruction(2000, 0, 1, OpCode.JA),
                True,
                (Byte(0), Byte(0), Byte(0), Byte(0), Byte(0)),
            ),
            # JAP
            (
                Instruction(2000, 0, 2, OpCode.JA),
                False,
                (Byte(1), Byte(0), Byte(0), Byte(0), Byte(0)),
            ),
            # JANN
            (
                Instruction(2000, 0, 3, OpCode.JA),
                True,
                (Byte(0), Byte(0), Byte(0), Byte(0), Byte(0)),
            ),
            # JANZ
            (
                Instruction(2000, 0, 4, OpCode.JA),
                True,
                (Byte(1), Byte(0), Byte(0), Byte(0), Byte(0)),
            ),
            # JANP
            (
                Instruction(2000, 0, 5, OpCode.JA),
                False,
                (Byte(0), Byte(0), Byte(0), Byte(0), Byte(0)),
            ),
        ]
